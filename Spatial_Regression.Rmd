...
The best fit comparatively.

  OLS | SLX | Model  |   Lag  | Model |   Err | Model |
----- | ----- | ------ |----- | ----- | ------ | ------ |
...
```{r bivariate map, message=FALSE, warning=FALSE, echo=TRUE, results='hide'}
...
final_map <- ggdraw() +
  ...
  draw_plot(legend, x = 0.07, y = 0.13, width = 0.4, height = 0.4) 
